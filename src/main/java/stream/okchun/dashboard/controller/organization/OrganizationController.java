...
public class OrganizationController {
	...
	@GetMapping("/{org_id}")
	public GlobalResponse<DetailedOrganizationInfo> getOrganizationDetail(
	...
	public String listMembers(@PathVariable("org_id") String orgId,
	...
	public String changeMemberRole(@PathVariable("org_id") String orgId,
								   @PathVariable("member_id") String memberId, @RequestBody Object body) {
		return "Role changed for member " + memberId + " in " + orgId;
	}

	@DeleteMapping("/{org_id}/members/{member_id}")
	public String removeMember(@PathVariable("org_id") String orgId,
	...
	public String listInvites(@PathVariable("org_id") String orgId,
							  @RequestParam(required = false) String cursor) {
		return "List of invites for " + orgId;
	}

	@DeleteMapping("/{org_id}/invites/{invite_id}")
	public String cancelInvite(@PathVariable("org_id") String orgId,
							   @PathVariable("invite_id") String inviteId) {
