...
public class ChannelController {
	...
	public String getChannelDetail(@PathVariable("org_id") String orgId,
	...
	public String updateChannel(@PathVariable("org_id") String orgId,
								@PathVariable("channel_id") String channelId, @RequestBody Object body) {
		return "Channel " + channelId + " updated in organization " + orgId;
	}

	@DeleteMapping("/organizations/{org_id}/channels/{channel_id}")
	public String archiveChannel(@PathVariable("org_id") String orgId,
								 @PathVariable("channel_id") String channelId) {
	...
	public String updateChannelSettings(@PathVariable("channel_id") String channelId,
	...
	public String getExtensionDetail(@PathVariable("channel_id") String channelId,
									 @PathVariable("extension_id") String extensionId) {
		return "Extension " + extensionId + " detail for channel " + channelId;
	}

	@PatchMapping("/channels/{channel_id}/extensions/{extension_id}")
	public String updateExtension(@PathVariable("channel_id") String channelId,
								  @PathVariable("extension_id") String extensionId,
								  @RequestBody Object body) {
	...
	public String removeExtension(@PathVariable("channel_id") String channelId,
								  @PathVariable("extension_id") String extensionId) {
	...
	public String invokeExtension(@PathVariable("channel_id") String channelId,
								  @PathVariable("extension_id") String extensionId,
								  @RequestBody Object body) {
